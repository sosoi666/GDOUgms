        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <form class="form-inline" action="../field/findByAnyAppField" method="post">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                        <c:forEach items="${appField}" var="thisfield">
                            <tr>
                                ...
                                <td><a href="../field/toAddAppointment?id=${thisfield.id}">添加预约</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
