    ...
    <ul class="nav menu">
        ...
        <li class="parent">
            ...
            <ul class="children collapse in" id="sub-item-1">
                ...
                <li>
                    <a  href="../field/findAllFieldTCourse">
                        教师上课场地申请
                    </a>
                </li>
            </ul>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <form class="form-inline" action="../field/findByAnyFieldToMatch" method="post">
                    ...
                    <table class="table table-striped">
                        ...
                        <c:forEach items="${list}" var="thisfield">
                            <tr>
                                ...
                                <td><a href="../field/toAddMatchApp?id=${thisfield.id}">申请</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
