...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">欢迎使用广东海洋大学体育管理系统-场地管理</h1>
        </div>
    </div><!--/.row-->
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">场馆公告</div>
                    <c:forEach items="${list}" var="notice">
                        <div class="panel-body">
                            <a href="../field/toNotice?id=${notice.id}" class="col-md-4"><span>${notice.title}</span></a><p class="text-right col-md-8" style="margin: 0px;">${notice.date}</p>
                        </div>
                        <hr size=8 style="COLOR: #ffd306;border-style:outset;width:490; margin: 0px;">
                    </c:forEach>
            </div>
        </div>
    </div><!--/.row-->
