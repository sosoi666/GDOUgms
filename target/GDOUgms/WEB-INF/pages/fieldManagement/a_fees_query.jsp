...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">场地收费标准</h1>
        </div>
    </div><!--/.row-->
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                        <c:forEach items="${list}" var="thisfees">
                            <tr>
                                <th scope="row">${thisfees.id}</th>
                                <td>${thisfees.fieldType}</td>
                                <td>${thisfees.cashPledge}</td>
                                <td>${thisfees.cost}</td>
                                <td><a href="../field/toEditFees?id=${thisfees.id}">编辑</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
