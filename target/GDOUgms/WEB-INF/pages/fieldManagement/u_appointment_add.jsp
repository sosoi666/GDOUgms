...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <li class="active"><a href="../field/findAllFieldToUser"> 场地预约</a></li>
        <li class="parent">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <form id="addAppForm" action="../field/addMyApp" style="margin: 30px; padding: 20px;">
                    ...
                    <div class="form-group">
                        <label >预约类型</label>
                        <input type="text" class="form-control" id="inputType" value="普通预约" placeholder="" name="type" readonly >
                    </div>
