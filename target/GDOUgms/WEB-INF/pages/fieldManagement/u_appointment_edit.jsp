    ...
    <ul class="nav menu">
        ...
        <li class="parent">
            ...
            <ul class="children collapse in" id="sub-item-2">
                <li>
                    <a class="active" href="../field/findMyAppointment?uid=${user.student_workedid}">
                        我的预约
                    </a>
                </li>
                <li>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <form id="editMyAppForm" action="../field/editMyApp" style="margin: 30px; padding: 20px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="appUid" placeholder="" name="uWid" readonly>
                    </div>
                    <div class="form-group">
                        <label >预约类型</label>
...
<script>
    ...
    $(function(){
        ...
        function loadWeek() {
            if ($("#appType").val() == "赛事预约"){
                ...
                $("#appWeek").append('<option value="' + nextWeek + '" >' + nextWeek + '</option>');
            }
    ...
    $("#editMyAppForm").submit(function () {
        if ($("#appUid").val() == "" ||$("#appsRemark").val() == ""){
            alert("你必须填写预约人学(工)号或备注信息。");
            return false;
        }else {
