    ...
    <ul class="nav menu">
        ...
        <li class="parent">
            ...
            <ul class="children collapse in" id="sub-item-1">
                <li>
                    <a class="active" href="../field/findAllFieldTMatch">
                        赛事场地申请
                    </a>
                </li>
                <li>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <form id="addMatchAppForm" action="../field/addMatchApp" style="margin: 30px; padding: 20px;">
                    ...
                    <div class="form-group">
                        <label >预约类型</label>
                        <input type="text" class="form-control" id="inputType" value="赛事预约" placeholder="" name="type" readonly >
                    </div>
...
<script>
    ...
    $("#addMatchAppForm").submit(function () {
