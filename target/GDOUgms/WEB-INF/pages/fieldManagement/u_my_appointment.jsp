                    ...
                    <table class="table table-striped">
                        ...
                        <c:forEach items="${myApp}" var="App">
                            <tr>
                                ...
                                <td>${App.type}</td>
                                <td>${App.remark}</td>
                                <td>${App.field.fees.cashPledge}</td>
                                <td>${App.field.fees.cost}</td>
                                <td><a href="../field/toEditMyApp?id=${App.id}">编辑</a>/<a href="javascript:void(0);" onclick="deleteevent(${App.id})">删除</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
...
<script>
    ...
    function deleteevent(id) {
        let thisId = id;
        let thisSrc = '../field/deleteMyApp?id=';
