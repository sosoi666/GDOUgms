    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <form id="editFieldForm" action="../field/updateField" style="margin: 30px; padding: 20px;">
                    <input type="hidden" value="${tField.id}" name="id">
                    <div class="form-group">
                        <label for="inputFieldName">场地名</label>
                        <input type="text" value="${tField.fieldName}" class="form-control" id="inputFieldName" name="fieldName">
                    </div>
                    <div class="form-group">
                        <label >场地类型</label>
                        <select class="form-control" id="tFieldType" name="fieldType">
                            <option>羽毛球场</option>
                            <option>乒乓球场</option>
                            <option>篮球场</option>
                            <option>足球场</option>
                    ...
                    <div class="form-group">
                        <label >使用类型</label>
                        <select class="form-control" id="tUseType" name="useType">
                            <option>普通</option>
                            <option>校队使用</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        <label >地址</label>
                        <select class="form-control" id="tSize" name="size">
                            <option>体育馆一楼</option>
                            <option>体育馆二楼</option>
                            <option>体育馆副馆</option>
                            <option>东区运动场</option>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <label >从</label>
                                <select id="t_start_day" class="form-control" name="beginDay">
                            ...
                            <div class="form-group">
                                <label >到</label>
                                <select id="t_end_day" class="form-control" name="endDay">
                                    <option value="1">周一</option>
                                    <option value="2">周二</option>
                                    <option value="3">周三</option>
                                    <option value="4">周四</option>
                    ...
                    <div class="form-group">
                        <label >备注(课程号)</label>
                        <textarea class="form-control" rows="3" name="remark">${tField.remark}</textarea>
                    </div>
