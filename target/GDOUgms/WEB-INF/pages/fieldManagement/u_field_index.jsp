...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">欢迎使用场地预约系统</h1>
        </div>
    </div><!--/.row-->
            ...
            <div class="panel panel-default">
                ...
                <c:forEach items="${list}" var="notice">
                    <div class="panel-body">
                        <a href="../field/toUserNotice?id=${notice.id}" class="col-md-4"><span>${notice.title}</span></a><p class="text-right col-md-8" style="margin: 0px;">${notice.date}</p>
                    </div>
